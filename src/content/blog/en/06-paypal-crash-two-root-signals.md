...
The actual patch adds 20 lines after `abort_creds(new)` at `abort_change:`. Its core is reproduced below; the [patch download](/notes/paypal-root-crash-2026-09-14/app-zygote-errno.patch) preserves the placement:
...
The [attachment README](/notes/paypal-root-crash-2026-09-14/README.md), [sanitized evidence summary](/notes/paypal-root-crash-2026-09-14/evidence-summary.json), [15 host-test results](/notes/paypal-root-crash-2026-09-14/error-path-tests.txt), and [checksum manifest](/notes/paypal-root-crash-2026-09-14/SHA256SUMS.txt) accompany the two installed source patches. No flashable image is included.
